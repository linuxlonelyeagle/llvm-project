...
// CHECK:           %[[VALUES_0:.*]] = sparse_tensor.values %[[ARG0]] : tensor<10xi32, {{.*}}> to memref<?xi32>
// CHECK:           %[[VALUES_1:.*]] = sparse_tensor.values %[[ARG1]] : tensor<10xi32, {{.*}}> to memref<?xi32>
...
// CHECK:             scf.if %[[ANDI_1]] {
// CHECK:               %[[LOAD_6:.*]] = memref.load %[[VALUES_0]]{{\[}}%[[VAL_2]]] : memref<?xi32>
// CHECK:               %[[LOAD_7:.*]] = memref.load %[[VALUES_1]]{{\[}}%[[VAL_3]]] : memref<?xi32>
// CHECK:               %[[ADDI_0:.*]] = arith.addi %[[LOAD_6]], %[[LOAD_7]] : i32
// CHECK:               memref.store %[[ADDI_0]], %[[TO_BUFFER_0]]{{\[}}%[[SELECT_0]]] : memref<10xi32>
// CHECK:             } else {
// CHECK:               scf.if %[[CMPI_3]] {
// CHECK:                 %[[LOAD_8:.*]] = memref.load %[[VALUES_0]]{{\[}}%[[VAL_2]]] : memref<?xi32>
// CHECK:                 memref.store %[[LOAD_8]], %[[TO_BUFFER_0]]{{\[}}%[[SELECT_0]]] : memref<10xi32>
// CHECK:               } else {
// CHECK:                 scf.if %[[CMPI_4]] {
// CHECK:                   %[[LOAD_9:.*]] = memref.load %[[VALUES_1]]{{\[}}%[[VAL_3]]] : memref<?xi32>
...
// CHECK:             %[[LOAD_11:.*]] = memref.load %[[VALUES_0]]{{\[}}%[[VAL_4]]] : memref<?xi32>
...
// CHECK:             %[[LOAD_13:.*]] = memref.load %[[VALUES_1]]{{\[}}%[[VAL_6]]] : memref<?xi32>
